...
from report_api.Utilities.Utils import time_count, get_medium_time, check_arguments, check_folder,try_save_writer
...
def new_report(os_list=["Android", "iOS"],
    ...
    result_files = []
    folder_dest = "Results/ActiveUsers/"
    ...
    for os_str in os_list:
        ...
        Report.set_events_data(additional_parameters=None,
                               ...
                               max_version=max_version,
                               countries_list=[],
                               events_list=[({"InitGameState","EnterSection","EnterPage"},)])
        ...
        while Report.get_next_event():
            #если пользователь установил игру недавно, не рассматриваем его
        ...
        filename=folder_dest + OS.get_os_string(os) + " " + "ActiveUsers.xlsx"
